            ...
            <div className="mt-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="bg-gray-50 p-6 rounded-lg shadow-md">
                  ...
                  <p className="text-gray-600">We are constantly seeking new ways to improve our platform and help our users.</p>
                </div>
                <div className="bg-gray-50 p-6 rounded-lg shadow-md">
                  <h4 className="text-xl font-bold mb-2">Transparency</h4>
                  <p className="text-gray-600">We believe in open communication and honest practices.</p>
                </div>
                <div className="bg-gray-50 p-6 rounded-lg shadow-md">
                  <h4 className="text-xl font-bold mb-2">User-Centricity</h4>
                  <p className="text-gray-600">Our users are at the heart of everything we do.</p>
                </div>
                <div className="bg-gray-50 p-6 rounded-lg shadow-md">
                  <h4 className="text-xl font-bold mb-2">Excellence</h4>
                  <p className="text-gray-600">We strive for the highest standards in all aspects of our work.</p>
                </div>
              </div>
            </div>
          </div>
